---
title: Tagung - Zivilgesellschaft und Demokratie
date: 2026-06-07
author:
  - name: Michael C. Zeller
    url: https://michaelczeller.github.io
    orcid: 0000-0002-2422-3896
description: "Rede auf der Tagung der Evangelischen Akademie Tutzing."
engine: knitr 
pres:
  pdf: "tutzing_zeller.pdf"
image: eatutzing.png
twitter-card:
  image: "eatutzing.png"
open-graph:
...
*Die Evangelische Akademie Tutzing veranstaltete am 5. und 7. Juni eine Tagung zum Thema [Zivilgesellschaft und Demokratie](https://www.eatutzing.de/veranstaltung/zivilgesellschaft-und-demokratie/#event-programm). Die Organisatoren – Pfr. Udo Hahn, Brigitte Grande und Prof. Dr. Swen Hutter – haben mich freundlicherweise zur Teilnahme eingeladen. Ich habe im Panel „Zivilgesellschaftliche Strategien gegen rechts – Wissenschaftliche Befunde“ mit Christin Jänicke und Henning Flad gesprochen. Meine kurze vorbereitete Rede lautete wie folgt.*
...
<p class="text-center">
  <a class="btn btn-primary btn-lg pres-download" href="`r rmarkdown::metadata$pres$pdf`" target="_blank">
    <i class="bi-download"></i>&ensp;Download presentation
  </a>
</p>

<div class="embed-container">
  <iframe src="`r rmarkdown::metadata$pres$pdf`" style="border: 0.5px"></iframe>
</div>
```



<!-- ![Slides](presentation_tutzing/tutzing_zeller.pdf) -->

<!-- ```{=html} -->
<!-- <object data="presentation_tutzing/tutzing_zeller.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;"> -->
<!--     <p>It appears you don't have a PDF plugin for this browser. -->
<!--     No biggie... you can <a href="presentation_tutzing/tutzing_zeller.pdf">click here to -->
<!--     download the PDF file.</a></p> -->
<!-- </object> -->
<!-- ``` -->

::: {.callout-note collapse="true" title="English version"}
...
4. Trigger other actors to stand up against the far right. In addition to directly achieve benefits for society by taking action against far-right actors, civil society actors are often quite effective at getting other actors to stand up too. Just a small selection from recent years, civil society actors have: (a) made it harder for far-right parties to meet and perform necessary organisational matters; (b) successfully lobbied payment services to restrict access to far-right groups; (c) filed for copyrights of neo-Nazi slogans and so denied neo-Nazis the right to sell merchandise and spread extremist propaganda. 
